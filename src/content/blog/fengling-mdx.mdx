---
title: Using mdx in FengLing
description: Using MDX in FengLing to enrich article content with more components
pubDate: 07 12 2024
...
This article describes how to use the components provided by FengLing in `mdx` to realize the functions that can't be realized by normal `md`.
...
The components provided by FengLing are placed in the `/mdx` folders. Write something under the document properties (frontmatter):
...
<LinkCard
  ...
  url="https://github.com/fenglingyubing/FengLing"
